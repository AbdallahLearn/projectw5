...
function Video() {
  ...
  <div className="card-body ms-5 max-sm:ms-0">
    <div className="img-text-side flex justify-between max-sm:flex-col">
        <div className="img">
            <img src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-video-2.jpg" alt="" />
        </div>
    ...
    <div className="img-text-side flex mt-10  max-sm:flex-col">
        <div className="img">
            <img src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-video-3.jpg" alt="" />
        </div>
        <div className="text ms-5">
    ...
    <div className="img-text-side flex mt-10  max-sm:flex-col">
        <div className="img">
            <img  src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-video-4.jpg" alt="" />
        </div>
        <div className="text ms-5">
    ...
    <div className="img-text-side flex mt-10  max-sm:flex-col">
        <div className="img">
            <img src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-video-5.jpg" alt="" />
        </div>
        <div className="text ms-5">

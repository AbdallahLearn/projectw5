...
function Contact() {
  return (
    <>
      ...
      <Navbar />
      <div className="card lg:card-side bg-base-100  p-20 mt-40 w-[90%] m-auto max-sm:p-0" >
        ...
        <div className="card-body">
          ...
          <div className="container-list">
            <img
              width="30"
              height="30"
              src="https://img.icons8.com/color/48/pizza.png"
              alt="pizza"
            />
            <ul>
              <li className="font-normal">FOOD CRITIC</li>
            ...
            <img
              width="30"
              height="30"
              src="https://img.icons8.com/dusk/64/speaker.png"
              alt="speaker"
            />{" "}
            <ul>
              <li className="font-normal">Influencer</li>
              <li className="text-gray-400 font-normal">
            ...
            >
              <path
                fill="#F6851F"
                d="M322.5,284.2c-2.6-8.6-9.4-13-18-14.3c-11.1-1.7-22.3,0.4-33.4,1.2c-14.4,1-28.8,1.6-43.1,3.8c0,0,0,0,0,0c-5.9,6.9-7.2,16.6-1.5,24.2c6.6,8.8,18.5,10.7,28.8,10.5c11.6-0.2,23.2-1.3,34.7-1.8c8-0.3,16.4-1.2,23.7-4.7C321.1,299.5,324.9,292.5,322.5,284.2z"
              ></path>
              <path
                fill="#D6E5E5"
                d="M385.7,257.3c-2.8-10.1-8.2-19.3-17.5-24.7c-11.7-6.8-25.1-9.8-35.8-18.4c-20.4-16.5-25.2-44.2-44.1-61.8c-16.9-15.7-38-19-60.2-20.6c-24.7-1.8-52.1-1.1-69.1,19.1c0,33.8,0,67.6,1.2,101.4c0.6,17.2,1.4,34.5,2.9,51.7c1,11.8,3.5,24,9.6,34.3c5.4,9.2,12.8,16.9,22.5,21.5c12.9,6.1,27.5,7.4,41.6,7.2c15.5-0.2,31-2,46.4-1.5c13.8,0.4,27.4,1.7,41.3,0.1c13.6-1.5,28.1-4.9,39.5-12.8c9.5-6.6,16-16.2,19.2-27.3c3.2-11.3,4.3-23,4.8-34.7C388.3,279.7,388.6,268.1,385.7,257.3z M202,203.7c-12.8-4.7-10.5-25.9,0.3-34.8c12.4-10.1,33.9-10.5,48.8-6.4c6.8,1.9,14.2,4.9,18.5,10.9c4.5,6.5,4.2,14.7,0.7,21.6c-5.5,10.8-21.9,9.2-32.2,10.2c-7.6,0.7-16.3-0.7-24,0.5c-3.9-0.6-7.7-1.1-11.6-1.2C202.3,204.3,202.1,204,202,203.7z M327,307c-6.9,6.3-15.6,9.2-24.7,10.7c-10,1.6-20.3,1.2-30.4,2c-12.6,1-26.3,2.4-38.4-2.3c-9.7-3.7-18.6-11.3-21-21.9c-2.4-10.6,0.1-20.8,7.7-28.8c1.2-1.3,2.7-1.8,4.1-1.7c0.7-0.5,1.6-0.9,2.7-1.1c18.6-2.8,37.5-2.9,56.2-4.8c18.3-1.9,44.2-0.5,49.7,21.5C335.1,289.7,334.5,300.2,327,307z"
              ></path>
              <path
                fill="#F6851F"
                d="M261.4,181.2c-1.7-3.8-6.3-5.8-10-7.1c-10.4-3.6-23.6-3.9-34.1-0.6c-6.2,1.9-11.6,5.5-13,12.3c-1,5.2-0.6,8.4,5.3,7.7c1.9-0.2,3.3,0.4,4.3,1.4c4.9-0.4,9.9-0.1,14.7-0.1c8.2-0.1,17.2-0.3,25.2-1.9c0.6-0.1,5.8-1.2,6-1.6c0.7-1.3,1.4-2.7,1.7-4.1C262,185.2,262.3,183.2,261.4,181.2z"
              ></path>
              <path
                fill="#F6851F"
            ...
            <ul>
              <li className="font-normal">Blogger</li>
              <li className="text-gray-400 font-normal">
        ...
        <div className="form me-10 shadow-xl p-10" style={{border: '10px solid black'}}>
            <h1>Let's Talk</h1>
            <label htmlFor="name">Name</label>
            <div className="name flex max-sm:flex-col">
            <input className="p-5 " type="text" name="" placeholder="first name" id="" style={{border:'1px solid black'}} />
            <input className="p-5" type="text" name=""  placeholder="last name"  id="" style={{border:'1px solid black'}} />
            </div>
            <label htmlFor="email">Email</label><br></br>
            <input className="p-5 w-full" type="email" name=""  placeholder="Email"  id="" style={{border:'1px solid black'}} />
            <label htmlFor="email">Subject</label><br></br>
            <input className="p-5 w-full" type="email" name=""  placeholder="Email"  id="" style={{border:'1px solid black'}} />
            <label htmlFor="email">Comment or Message *</label><br></br>
            <input className="p-5 w-full" type="email" name=""  placeholder=""  id="" style={{border:'1px solid black', padding:'60px 0'}} />

...
function App() {
  return (
    <>
      <div className="container-side  top-0 right-0 absolute h-screen w-[40%]  bg-[#c99584]"></div>
      <Navbar />
      <Header />
      <div className="container-latest mt-20 flex justify-between w-[85%] m-auto max-sm:block text-center">
      ...
      <div className="container-review w-[85%] m-auto gap-10 mt-20 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  justify-items-center">
        <Review
          img="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-review-img-1.jpg"
        ...
        />
        <Review
          img="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-latest-review-img-2.jpg"
      ...
      <div className="container-best bg-[#f3efee] pb-20 ">
        <div className="container-latest mt-20 text-center w-[90%] m-auto max-sm:block">
          <h1 className="text-5xl max-sm:text-3xl pt-20 mb-5">
        ...
        <div className="container-review w-[85%] m-auto gap-10 mt-20 grid mb-44 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  justify-items-center">
          <Best
      ...
      <div className="container-video w-[90%] m-auto max-sm:w-[95%] ">
        <h1 className="text-5xl mb-20 max-sm:text-center text-[28px]">Latest Videos</h1>
        <Video />
      </div>
